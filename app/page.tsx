...
export default function LoginPage() {
  ...
  const border  = darkMode ? '#444'    : '#d1d5db';
  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden"
        style={{ background: 'linear-gradient(300deg, #0b7bf2 0%, #0ba3e4 50%, #2aeb04da 100%)' }}>
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative transition-all duration-300"
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-8">
            <div className="px-2 py-1 rounded-lg" style={{ background: 'white', border: '1px solid #eee' }}>
              <img src="/images/Touras12334.png" alt="Touras"
                className="h-8 w-auto object-contain"
                onError={e => { (e.target as any).style.display = 'none'; }} />
            </div>
            <span className="text-2xl font-black" style={{ color: text }}>
              tour<span style={{ color: '#00a4d6' }}>as</span>
            </span>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                style={{
                  border:     `1.5px solid ${error ? '#00a4d6' : border}`,
                  color:      text,
                  background: inputBg,
                }}
                onFocus={e => e.target.style.borderColor = '#00a4d6'}
                onBlur={e  => e.target.style.borderColor = error ? '#00a4d6' : border}
              />
            </div>
            ...
            {error && (
              <p className="text-sm text-center px-3 py-2 rounded-lg"
                style={{ color: '#cc0000', background: '#fff5f5', border: '1px solid #fecdd3' }}>
                {error}
              </p>
            )}
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs" style={{ color: subtext }}>Quick Demo Access</span>
            <div className="flex-1 h-px" style={{ background: border }} />
          </div>
          ...
          <p className="text-center text-xs mt-6" style={{ color: subtext }}>
            ...
            <span className="font-semibold cursor-pointer" style={{ color: text }}>
              Sign up
            </span>
          </p>
        </div>
