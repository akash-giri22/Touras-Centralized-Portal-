...
import {
  ...
  Briefcase, X, Sun, Moon, ShieldCheck, Cloud, Ticket,
} from 'lucide-react'; 
...
const NAV_BY_ROLE: Record<string, any[]> = {
  employee: [
   ...
   // { label: 'My Licenses',  href: '/dashboard/my-licenses',  icon: <Key             className="w-4 h-4" /> },
    { label: 'Requests',     href: '/dashboard/requests',     icon: <SendHorizonal   className="w-4 h-4" /> },
    { label: 'AWS Requests', href: '/dashboard/aws-requests', icon: <Cloud           className="w-4 h-4" /> },
  ...
  manager: [
    ...
    { label: 'Jira Integration', href: '/dashboard/jira-integration', icon: <GitBranch       className="w-4 h-4" /> },
    { label: 'AWS Integration',  href: '/dashboard/aws-integration',  icon: <Cloud           className="w-4 h-4" /> },
  ...
  admin: [
    ...
    { label: 'Licenses',           href: '/dashboard/licenses',         icon: <Key             className="w-4 h-4" /> },
    { label: 'Requests',           href: '/dashboard/requests',         icon: <SendHorizonal   className="w-4 h-4" /> },
    { label: 'AWS Requests',       href: '/dashboard/aws-requests',     icon: <Cloud           className="w-4 h-4" /> },
    { label: 'Jira Integration',   href: '/dashboard/jira-integration', icon: <GitBranch       className="w-4 h-4" /> },
    { label: 'AWS Integration',    href: '/dashboard/aws-integration',  icon: <Cloud           className="w-4 h-4" /> },
    { label: 'Sync from Entra ID', href: '/dashboard/sync',             icon: <GitBranch       className="w-4 h-4" /> },
